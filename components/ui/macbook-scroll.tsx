...
export const KBtn = ({
    ...
    return (
        <>
            ...
            {}
            <style jsx global>{`
        @keyframes rgbBreathingPastel {
        0% {
            box-shadow: 0 0 10px 2px #ffadad, 0 0 10px 2px #ffadad;
            }
        33% {
            box-shadow: 0 0 10px 2px #caffbf, 0 0 10px 2px #caffbf;
            }
        66% {
            box-shadow: 0 0 10px 2px #9bf6ff, 0 0 10px 2px #9bf6ff;
            }
        100% {
            box-shadow: 0 0 10px 2px #ffadad, 0 0 10px 2px #ffadad;
            }
        ...
        .animate-rgb-pastel {
            animation: rgbBreathingPastel 3s ease-in-out infinite;
        }
        `}</style>
        </>
    );
