...
export const MenuItem = ({
    ...
    setActive: (item: string | null) => void; // 1. Alterado o tipo aqui
    active: string | null;
    item: string;
    ...
    return (
        <div
            ...
            onMouseLeave={() => setActive(null)} // 2. Adicionado evento de mouse leave
        ...
        >
            ...
            <AnimatePresence>
                {active === item && (
                    ...
                    >
                        {/* 3. Adicionada área de hover segura */}
...
export const Menu = ({
    ...
    return (
        <motion.nav
            ...
            onMouseLeave={() => {
                setIsHovered(false);
                setActive(null); // 4. Removido o setTimeout
            }}
        >
            <motion.div
